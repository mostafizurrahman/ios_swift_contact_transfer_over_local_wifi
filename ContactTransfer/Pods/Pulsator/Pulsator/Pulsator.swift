...
internal let applicationWillBecomeActiveNotfication = UIApplication.didBecomeActiveNotification
internal let applicationDidResignActiveNotification = UIApplication.willResignActiveNotification
#elseif os(macOS)
import Cocoa
